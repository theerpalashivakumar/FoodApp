    ...
    <div>
      <div className="flex justify-between bg-slate-500 mb-5 py-4 px-2 items-center">
        ...
        <div className="w-2/12">
          ...
          <img src={IMAGE_ID_FOOD+imageId} className="rounded-2xl"/>
          <span className="relative bottom-8 left-24 bg-black rounded-lg text-white p-3 cursor-pointer"> Add     +</span>
        </div>
      </div>
    </div>
  );
